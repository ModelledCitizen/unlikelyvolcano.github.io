...
$featurearray = array("Ambivalent Sexism" => array("Women have it easier than men in our country these days","When women demand equality these days, they are actually seeking special favors","Over the past few years, we have been showing more concern about the treatment of women than is warranted â€“ women are doing just fine","I can't understand why women are still concerned about societal limitations of women's opportunities; women no longer have it harder than men"),"Racism" => array("Too many immigrants today seem to want special treatment","Irish, Italians, Jewish, and many other minorities overcame prejudice and worked their way up. Today's immigrants should do the same","Immigrants today need to be more like prior generations of immigrants, and prioritize learning English and adopting the American way of life","If immigrants would only try harder, they could be just as well off as people born in America"),"Age" => array("50","70","90"));
