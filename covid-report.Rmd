...
state_testing <- read.csv("https://covidtracking.com/api/states.csv", stringsAsFactors = F)
```
...
state_map_testing <- merge(state_map, state_testing, by.x = "STUSPS", by.y = "state")
...
**US Cases:** `r prettyNum(us_confirmed, big.mark = ",")`

**US Deaths:** `r prettyNum(us_deaths, big.mark = ",")`
...
ggplot(us_testing, aes(x = date, y = total)) +
  geom_point(color = "firebrick", aes(y = positive)) +
  geom_line(color = "firebrick", aes(y = positive)) +
  geom_point(color = "goldenrod", aes(y = negative)) +
  geom_line(color = "goldenrod", aes(y = negative)) +
  geom_point(color = "dodgerblue") +
  geom_line(color = "dodgerblue") +
  scale_x_date(name = "Date",
               date_breaks = "1 week",
               date_labels = "%b %e") +
  scale_y_continuous(name = "Tests", n.breaks = 11) +
  theme_dark
```
