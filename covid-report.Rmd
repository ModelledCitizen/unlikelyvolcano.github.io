...
us_mapping <-
  data.frame(
    state = confirmed[confirmed$Country.Region == "US" ,"Province.State"],
    Latitude = confirmed[confirmed$Country.Region == "US" ,"Lat"],
    Longitude = confirmed[confirmed$Country.Region == "US" ,"Long"],
    cases = confirmed[confirmed$Country.Region == "US" , ncol(confirmed)],
    stringsAsFactors = F
  )
us_mapping <- us_mapping[grep(",", us_mapping$state, invert = T), ]
...
leaflet(us_mapping) %>%
  ...
  addCircleMarkers(
    lng = us_mapping$Longitude,
    lat = us_mapping$Latitude,
    label = lab,
