...
ph_url <-
  "https://public.tableau.com/vizql/w/COP-COVID-19/v/Stacked/vud/sessions/2CA5C80F549145EF815B6DEDEA141D87-0:0/views/7713620505763405234_17874758422068147630?csv=true"
tryCatch({
...
## By State
```{r testing:state, fig.show="animate", ffmpeg.format="gif", dev="jpeg", eval=FALSE}
state_ts <- list()
state_names <- c()
