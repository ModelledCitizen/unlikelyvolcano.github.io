...
leaflet(wrld_mapping) %>%
  ...
  addCircleMarkers(
    ...
    radius = 2 * log(wrld_mapping$cases),
    weight = 10,
    fillColor = "red",
    stroke = F
  )
...
### Rate of Change in New Cases (US)
...
### Rate of Change in New Cases (Global)
