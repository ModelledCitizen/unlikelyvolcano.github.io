...
```{r us:total}
plot(usa, main = "Cases of COVID-19 Report in the United States", pch = 20)
```
...
plot(
  usa$date,
  log(usa$cases),
  main = "Log Cases of COVID-19 Report in the United States",
  pch = 20,
  xlab = "Date",
  ylab = "log(Cases)"
)
...
```{r world:total}
plot(world, main = "Cases of COVID-19 Report", pch = 20)
```
...
plot(
  world$date,
  log(world$cases),
  main = "Logged Cases of COVID-19 Report",
  pch = 20,
  xlab = "Date",
  ylab = "log(Cases)"
)
